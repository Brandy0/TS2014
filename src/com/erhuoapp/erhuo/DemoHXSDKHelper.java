...
public class DemoHXSDKHelper extends HXSDKHelper{
    ...
    @Override
    protected void initHXOptions(Context context){
      ...
      return new OnMessageNotifyListener() {
          ...
          public String onNewMessageNotify(EMMessage message) {
              ...
              HeadAndName mHeadAndName = new HeadAndName(context);
 			  UserHeadAndName mUserHeadAndName = mHeadAndName.selectOne(message.getFrom());
              return mUserHeadAndName.getNick() + ": " + ticker;
          }

          @Override
          public String onLatestMessageNotify(EMMessage message, int fromUsersNum, int messageNum) {
//              return null;
              return fromUsersNum + "个贰货，发来了" + messageNum + "条消息";
          }
