...
import com.erhuoapp.erhuo.adapter.AdapterOtherSellingList;
 ...
 * @datetime 15/1/20
 */
public class FragmentOtherSelling extends Fragment implements View.OnClickListener, IFragment, PullToRefreshBase.OnRefreshListener<ListView> {

    private static final String TAG = "FragmentOtherSelling";
    ...
    private AdapterOtherSellingList adapterGoodsList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context = getActivity();
        View contentView = inflater.inflate(R.layout.fragment_userselling, null);
        ...
        adapterGoodsList = new AdapterOtherSellingList(context, 0, goodsList);
        adapterGoodsList.setListener(new AdapterOtherSellingList.ItemClickedListener() {
            @Override
    ...
    public void onResume() {
        ...
        isFragmentInit = true;
        refresh();//这个时候调用一次，也就是第一个Fragment才调用，其他的Fragment不需要这样
        //其他的Fragment在上面的按钮点击之后会一次执行onCreateView -> onResume -> refresh
    }
    ...
    private void refreshData(boolean removeData, boolean refreshData) {
        ...
        new CloudUtil().OtherSelling(params, new OtherSellingCallback());
    }

    // 用户收藏加载完毕的回调
    class OtherSellingCallback implements CloudUtil.OnPostRequest<ArrayList<EntityGoodsSelling>> {
