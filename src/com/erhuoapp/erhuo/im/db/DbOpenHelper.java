...
public class DbOpenHelper extends SQLiteOpenHelper{
	...
	private static final String USER_HEAD_NAME_TABLE_CREATE = "CREATE TABLE "
		+ HeadAndName.TABLE_NAME + " ("
		+ HeadAndName.COLUMN_HEAD +" TEXT, "
		+ HeadAndName.COLUMN_NAME_NICK +" TEXT, "
		+ HeadAndName.COLUMN_NAME_ID + " TEXT); ";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(USER_HEAD_NAME_TABLE_CREATE);
