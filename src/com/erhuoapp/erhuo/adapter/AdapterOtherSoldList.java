...
public class AdapterOtherSoldList extends ArrayAdapter<EntityGoodsSelling> {

    private List<EntityGoodsSelling> list;
    private DisplayImageOptions displayImageOptions;

    public AdapterOtherSoldList(Context context, int resource, List<EntityGoodsSelling> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null && convertView.getTag() instanceof ViewHolder) {
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_listview_othersold, parent, false);
