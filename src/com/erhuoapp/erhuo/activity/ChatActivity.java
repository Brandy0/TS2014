...
import com.erhuoapp.erhuo.adapter.ExpressionAdapter;
import com.erhuoapp.erhuo.adapter.ExpressionPagerAdapter;
import com.erhuoapp.erhuo.adapter.MessageAdapter;
...
import com.erhuoapp.erhuo.im.utils.ExpandGridView;
import com.erhuoapp.erhuo.im.utils.ImageUtils;
import com.erhuoapp.erhuo.im.utils.PasteEditText;
...
public class ChatActivity extends BaseActivity implements OnClickListener {
	...
	RelativeLayout note_click;
	TextView user_name;
	PasteEditText et_sendphone;
	PasteEditText et_sendplace;
	TextView finish_send;
	ImageView btn_my_note;
	...
	protected void initView() {
	    ...
	    finish_send.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if("".equals(phone)){
					ToastUtil.showShortToast(ChatActivity.this, "电话不能为空");
					return;
				}
				if("".equals(place)){
					ToastUtil.showShortToast(ChatActivity.this, "地址不能为空");
					return;
				}
				EntityUserInfo userInfo = AppUtil.getInstance().getBasicUserInfo();
				 
				String s = "姓名:"+userInfo.getNickName()+"\n电话:"+phone+"\n地址:"+place;
				sendText(s);
...
//				startActivity(intent);
	...
	public void selectPicFromCamera() {
		...
		cameraFile = new File(PathUtil.getInstance().getImagePath(), ErHuoApplication.getInstance().getUserName()
...
//				REQUEST_CODE_GROUP_DETAIL);
	...
	private class NewMessageBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
		    ...
		    HeadAndName mHeadAndName = new HeadAndName(ChatActivity.this);
				...
				try {
					...
					if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
						...
						if (filename != "delete_expression") { // 不是删除键，显示表情
							...
							Class clz = Class.forName("com.erhuoapp.erhuo.im.utils.SmileUtils");
	...
	public void onBackPressed() {
		...
		if (note_click.getVisibility() == View.VISIBLE) {
			note_click.setVisibility(View.INVISIBLE);
