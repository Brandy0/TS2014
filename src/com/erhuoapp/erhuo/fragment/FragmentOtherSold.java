...
import com.erhuoapp.erhuo.adapter.AdapterOtherSoldList;
 ...
 * @datetime 15/1/10
 */
public class FragmentOtherSold extends Fragment implements View.OnClickListener, IFragment, PullToRefreshBase.OnRefreshListener<ListView> {

    private static final String TAG = "FragmentOtherSold";
    ...
    private AdapterOtherSoldList adapterGoodsList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapterGoodsList = new AdapterOtherSoldList(context, 0, goodsList);
        adapterGoodsList.setListener(new AdapterOtherSoldList.ItemClickedListener() {
            @Override
    ...
    private void refreshData(boolean removeData, boolean refreshData) {
        ...
        new CloudUtil().OtherSold(params, new OtherSoldCallback());
    }

    // 用户收藏加载完毕的回调
    class OtherSoldCallback implements CloudUtil.OnPostRequest<ArrayList<EntityGoodsSelling>> {
